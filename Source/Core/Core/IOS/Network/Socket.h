...
#elif defined(__linux__) or defined(__EMSCRIPTEN__) or defined(__APPLE__) or defined(__FreeBSD__) or \
    defined(__NetBSD__) or defined(__OpenBSD__) or defined(__HAIKU__)
#include <arpa/inet.h>
#include <netdb.h>
#include <sys/ioctl.h>
#include <sys/socket.h>
#include <sys/types.h>
#if defined(ANDROID) || defined(__EMSCRIPTEN__) || defined(__HAIKU__)
#include <fcntl.h>
#else
#include <sys/fcntl.h>
#endif
